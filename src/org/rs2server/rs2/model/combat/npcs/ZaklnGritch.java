...
public class ZaklnGritch extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case RANGE:
			...
			attacker.playGraphics(Graphic.create(1208));
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1209, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
