...
public class Bree extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case RANGE:
			...
			attacker.playGraphics(Graphic.create(1187));
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1188, 45, 50, clientSpeed, 62, 35, victim.getProjectileLockonIndex(), 10, 48));
