...
/**
 * SergeantSteerwill bandos minion
 * @author Canownueasy
 *
 */
public class SergeantSteelwill extends AbstractCombatAction {
	
	/**
	 * The singleton instance.
	 */
	private static final SergeantSteelwill INSTANCE = new SergeantSteelwill();
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1203, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
		...
		World.getWorld().submit(new Tickable(hitDelay) {
			@Override
			public void execute() {
				victim.playGraphics(Graphic.create(1204));
