...
public class Growler extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1185, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
		...
		World.getWorld().submit(new Tickable(hitDelay) {
			@Override
			public void execute() {
				victim.playGraphics(Graphic.create(hit > 0 ? 1186 : 85));
