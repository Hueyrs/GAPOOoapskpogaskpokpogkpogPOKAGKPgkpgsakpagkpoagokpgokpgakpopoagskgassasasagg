...
function iceBurst(attacker, victim, spell, autocast, clientSpeed, magicCombatAction, gfxDelay, delay) {
	...
	magicCombatAction.hitEnemy(attacker, victim, spell, Graphic.create(gfx, 80, 0), PoisonType.NONE, true, 22, 4, 17);
	attacker.getSkills().addExperience(Skills.MAGIC, Constants.EXP_MODIFIER * 40);
	attacker.getCombatState().setSpellDelay(6);
	attacker.getCombatState().setAttackDelay(4);
}
...
function iceBarrage(attacker, victim, spell, autocast, clientSpeed, magicCombatAction, gfxDelay, delay) {
	...
	magicCombatAction.hitEnemy(attacker, victim, spell, Graphic.create(gfx, 60, 0), PoisonType.NONE, true, 30, 4, 33);
